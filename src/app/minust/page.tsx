...
export default function Minust() {
  return (
    <Page width="900px">
      ...
      <Paragraph>
        <strong>{texts.title3}</strong>
        {texts.paragraph3}
      </Paragraph>
      <Paragraph>
        <strong>{texts.title4}</strong>
        {texts.paragraph4}
      </Paragraph>
      <Paragraph>
        <strong>{texts.title5}</strong>
        {texts.paragraph5}
      </Paragraph>
      <Paragraph
        style={{
